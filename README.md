...
# 👋 Hi, I'm Puriphat Srikamnoi

![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=58A6FF&center=true&vCenter=true&width=500&lines=Full+Stack+Developer;AI+Automation;Building+multi-agent+AI+systems)
...
![.NET Backend](https://img.shields.io/badge/.NET-512BD4?style=for-the-badge&logo=dotnet&logoColor=white)
...
### 🎨 [Pixel Studio — Multi-Model AI Design Arena](https://github.com/PuriphatXXVII/pixel-studio)
> Claude, GPT and Gemini battle on the same UI brief — a vision critic (Claude Opus) scores each rendered design, then a cross-vendor relay (Designer → Architect → Refiner → Finisher) collaboratively polishes the winner. BYOK, live leaderboard, shareable results.
...
### 💬 [SmartDesk AI — RAG Customer-Support SaaS](https://github.com/PuriphatXXVII/SmartDesk-AI)
> Multi-tenant RAG platform — upload your docs, embed one line of code, and let AI answer customer questions with citations. **[Live demo →](https://smart-desk-ai-lyart.vercel.app)**

![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat&logo=next.js&logoColor=white)
![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat&logo=fastapi&logoColor=white)
![Claude AI](https://img.shields.io/badge/Claude_AI-D97757?style=flat&logo=anthropic&logoColor=white)
![pgvector](https://img.shields.io/badge/Postgres_pgvector-4169E1?style=flat&logo=postgresql&logoColor=white)
![Supabase](https://img.shields.io/badge/Supabase-3FCF8E?style=flat&logo=supabase&logoColor=white)
![Vercel](https://img.shields.io/badge/Vercel-000000?style=flat&logo=vercel&logoColor=white)

### 📡 [JobRadar AI — AI Job-Hunt Copilot](https://github.com/PuriphatXXVII/jobradar-ai)
> AI-assisted Playwright scraper that hunts remote dev/AI jobs and matches them against your profile with Claude — from raw listings to a clean, ranked shortlist.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white)
![Playwright](https://img.shields.io/badge/Playwright-2EAD33?style=flat&logo=playwright&logoColor=white)
![Claude AI](https://img.shields.io/badge/Claude_AI-D97757?style=flat&logo=anthropic&logoColor=white)

### 🤖 [AI-Powered CI/CD Pipeline Monitor](https://github.com/PuriphatXXVII/ai-cicd-monitor)
> Automatically detects pipeline failures, analyzes errors with Claude AI, creates fix PRs, and sends Discord notifications.
